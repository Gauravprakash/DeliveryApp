...
var window: UIWindow?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        if DefaultManager.getIsLoggedIn(){
            ...
            if let vc = Storyboards.MAIN.storyBoard.instantiateViewController(withIdentifier: "DefaultVC") as? UINavigationController{
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "ThiqahDelivery")
